...
```bash
npx skills add adityarawat175223-gif/my-agent-skills --skill skillname
# or add all skills from the repo
npx skills add adityarawat175223-gif/my-agent-skills
```
...
```bash
git clone git@github.com:adityarawat175223-gif/my-agent-skills.git ~/temp-skills
```
